package com.jaboumal.test;/*package com.jaboumal.test;
...
import java.com.jaboumal.util.Enumeration;
import java.com.jaboumal.util.Properties;
import java.com.jaboumal.util.TooManyListenersException;
...
public class ScanHandler implements Runnable, SerialPortEventListener {
    ...
    public ScanHandler() {
        ...
        // open serial port
        try {
            TimeStamp = new java.com.jaboumal.util.Date().toString();
    ...
    public static void main(String[] args) {
        ...
        try {
            myProperties.load(new FileInputStream("config.yaml"));
